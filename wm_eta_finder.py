...
file_name = f"data/data_gen_iter_{_max_iter}_mu_size_{_dim_eta}"\
           +f"_rand_seed_{_random_seed}_omega_2_range_{_omega_2_range}_gwm_lambda_1_{STATUS}.dat"
file_name_raw = f"data/raw_data_gen_iter_{_max_iter}_mu_size_{_dim_eta}"\
           +f"_rand_seed_{_random_seed}_omega_2_range_{_omega_2_range}_gwm_lambda_1_{STATUS}.dat"
file_name_aux = f"data/aux_data_gen_iter_{_max_iter}_mu_size_{_dim_eta}"\
           +f"_rand_seed_{_random_seed}_omega_2_range_{_omega_2_range}_gwm_lambda_1_{STATUS}.dat"
